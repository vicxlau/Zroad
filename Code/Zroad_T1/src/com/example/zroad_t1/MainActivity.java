...
public class MainActivity extends Activity {
	...
	public static final String EXTRAS_KEY_ACTIVITY_TITLE_STRING = "Zroad POI";
	public static final String EXTRAS_KEY_ACTIVITY_ARCHITECT_WORLD_URL = "Webservice"+ File.separator +"index.html";
	...
	public void onCreate( Bundle savedInstanceState ) {
		...
		this.sensorAccuracyListener = new SensorAccuracyChangeListener() {
			...
			public void onCompassAccuracyChanged( int accuracy ) {
				...
				if ( accuracy < SensorManager.SENSOR_STATUS_ACCURACY_MEDIUM && MainActivity.this != null && !MainActivity.this.isFinishing() ) {
			...
			public void onLocationChanged( final Location location ) {
				...
				if ( MainActivity.this.architectView != null ) {
					if ( location.hasAltitude() ) {
						MainActivity.this.architectView.setLocation( location.getLatitude(), location.getLongitude(), location.getAltitude(), location.hasAccuracy() ? location.getAccuracy() : 1000 );
					} else {
